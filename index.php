...
<head>
    ...
    <!--====== Title ======-->
    <title>Konsultan IT, CCTV, Suplier Perangkat Komputer - CV. Mandiri Putra Nusa</title>
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="navbar-btn d-none d-sm-inline-block">
                                <a class="main-btn" data-scroll-nav="0" href="#pricing">Hubungi Kami</a>
                            </div>
                        </nav> <!-- navbar -->
                    </div>
                </div> <!-- row -->
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="header-hero-content">
                            <h1 class="hero-title wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s"><b>Kami membuat</b> <span>Visi Anda</span> Menjadi Sebuah <b>Aksi.</b></h1>
                            <p class="text wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">Bergerak dan memfokuskan diri pada bidang Konsultan IT, pengembang perangkat lunak dan CCTV. Kami hadir memberikan solusi, perencanaan, dan strategi yang terintegerasi demi terciptanya ruang lingkup teknologi yang lebih baik.</p>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-5 col-lg-6 col-md-8 col-sm-9">
                    <div class="section-title text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                        ...
                        <h4 class="title">Berbagai layanan<span> yang siap membuat bisnis Anda lebih baik</span></h4>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="our-services-tab pt-30">
                        <ul class="nav justify-content-center wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="active" id="it-project" data-toggle="tab" href="#business" role="tab" aria-controls="business" aria-selected="true">
                                    <i class="lni-briefcase"></i> <span>IT Project <br></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a id="digital-tab" data-toggle="tab" href="#ritel" role="tab" aria-controls="digital" aria-selected="false">
                                    <i class="lni-bullhorn"></i> <span>Solusi <br> Bisnis Ritel</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a id="market-tab" data-toggle="tab" href="#cctv" role="tab" aria-controls="market" aria-selected="false">
                                    <i class="lni-stats-up"></i> <span>Perencanaan dan <br>Instalasi CCTV</span>
                                </a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="business" role="tabpanel" aria-labelledby=it-project">
                                <div class="row">
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="our-services-content mt-45">
                                            <h3 class="services-title">Pembuatan perangkat lunak dan <span>integrasi sistem.</span></h3>
                                            <p class="text">Desain dan implementasi infrastruktur IT serta pengembangan perangkat lunak untuk menunjang sistem otomasi bisnis. </p>

                                            <div class="our-services-progress d-flex align-items-center mt-55">
                                                <div class="progress-content">
                                                    <h5 class="progress-title">- Manajemen Dokumen Digital.</h4>
                                                    <h5 class="progress-title">- Mesin Absesnsi Sidik Jari.</h4>
                                                    <h5 class="progress-title">- Maintenance workstation dan server.</h4>
                                                    <h5 class="progress-title">- Perencanaan dan implementasi jaringan komputer.</h4>
                                                    <h5 class="progress-title">- Pembuatan Online Store</h4>
                                                    <h5 class="progress-title">- Pembuatan Website Company Profile</h4>
                                                    <h5 class="progress-title">- Dll</h4>
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="ritel" role="tabpanel" aria-labelledby="digital-tab">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="our-services-image mt-50">
                                            <img src="assets/images/our-service-1.jpg" alt="service">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="our-services-content mt-45">
                                            <h3 class="services-title">Aplikasi <span>Point of Sales.</span></h3>
                                            <p class="text">Pencatatan penjualan dan pembelian barang sampai dengan laporan laba rugi dan manajemen karyawan untuk menunjang kebutuhan bisnis ritel Anda.</p>

                                            <div class="our-services-progress d-flex align-items-center mt-55">
                                                <div class="progress-content">
                                                    <h4 class="progress-title">Hubungi kami <br> untuk penawaran lebih lanjut.</h4>
                                                </div>
                                            </div>
                                        </div> <!-- our services content -->
                                    </div>
                            ...
                            <div class="tab-pane fade" id="cctv" role="tabpanel" aria-labelledby="market-tab">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="our-services-image mt-50">
                                            <img src="assets/images/our-service-1.jpg" alt="service">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="our-services-content mt-45">
                                            <h3 class="services-title">Perencanaan Titik dan Lokasi <span>Serta Pemasangan CCTV.</span></h3>
                                            <p class="text">Perencanaan dan pemasangan sampai dengan konfigurasi dan integrasi CCTV secara online dengan membangun infrastruktur terbaik.</p>
                                        </div> <!-- our services content -->
                                    </div>
                                </div> <!-- row -->
                            </div>
